...
| -------- | ----------------- | ---------------------------------------------------------------------------------- | -------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| P0       | Playability       | Add a repeatable browser smoke checklist for GitHub Pages and local-server launch. | TODO     | Checklist covers live demo, local `http://localhost:8000`, direct `file://` guard, SWF `200`, desktop/mobile layout, keyboard focus, and console error expectations.  |
